...
#replay_memory = decompress_pickle(root_path(ignore_cwd=True) + "/replayMemory/running_replay_memory.pbz2")

#random_indices = np.random.choice(range(len(replay_memory)), size=32)
